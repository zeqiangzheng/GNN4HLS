...
prj_path = 'D:/Vivado/!Drive/Reports'

def extract_verilog(prj_path):
    xml_file = f"{prj_path}/verilog/export_impl.xml"
    ...
    with open(xml_file) as fd:
        ...
        period = float(doc['profile']['TimingReport']['AchievedClockPeriod'])
...
def main():
    print(extract_verilog(prj_path))
